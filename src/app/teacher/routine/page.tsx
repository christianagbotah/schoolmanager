    ...
    <DashboardLayout>
      <div className="space-y-6">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <div>
            <h1 className="text-2xl font-bold text-slate-900 tracking-tight">My Timetable</h1>
              ...
              <Card className="gap-4">
                <CardContent className="py-16">
                  <div className="text-center">
                    ...
                    <h3 className="text-lg font-medium text-slate-600">No classes on this day</h3>
                  </div>
                </CardContent>
              </Card>
            ) : (
            ...
            <Card className="gap-4">
              <CardContent className="py-16">
                <div className="text-center">
                  ...
                  <p className="text-sm text-slate-400 mt-1">Timetable has not been set up yet</p>
                </div>
              </CardContent>
            </Card>
          ) : (
        ...
        {!selectedSectionId && !isLoading && (
          <Card className="gap-4">
            <CardContent className="py-16">
              <div className="text-center">
                <Calendar className="w-16 h-16 text-slate-200 mx-auto mb-4" />
                <h3 className="text-lg font-medium text-slate-600">Select a class to view timetable</h3>
              </div>
            </CardContent>
          </Card>
        )}
