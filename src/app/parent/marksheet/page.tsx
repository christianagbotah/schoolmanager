...
export default function ParentMarksheetPage() {
  ...
  // Fetch marks when both student and exam selected
  const fetchMarks = useCallback(async () => {
    ...
    try {
      const res = await fetch(
        `/api/parent/marksheet?student_id=${selectedStudent}&exam_id=${selectedExam}`
      );
      ...
      <div className="space-y-6">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <div>
            ...
            <p className="text-sm text-slate-500 mt-1">View detailed academic results for your children</p>
          </div>
          {marks.length > 0 && (
            <Button
              onClick={() => window.print()}
              variant="outline"
              className="min-w-[44px] min-h-[44px] print:hidden"
            >
        ...
        {selectedStudent && selectedExam && (
          <>
            {/* Student Info Banner */}
            <Card className="bg-gradient-to-r from-emerald-600 to-teal-600 border-0 text-white print:shadow-none">
              <CardContent className="p-6">
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                  ...
                  <div className="text-right">
                    <p className="text-sm text-emerald-100">Exam</p>
              ...
              <CardHeader>
                <div className="flex items-center gap-2">
                  ...
                  <CardTitle className="text-base font-semibold">
                    Subject Results — {children.find((s) => s.student_id === parseInt(selectedStudent))?.name || "Student"}
                  </CardTitle>
                </div>
              </CardHeader>
          ...
          <Card className="gap-4">
            <CardContent className="py-16">
              <div className="text-center">
                ...
                <h3 className="text-lg font-medium text-slate-600">Select a child to view marksheet</h3>
                <p className="text-sm text-slate-400 mt-1">Choose a child and exam from the dropdowns above</p>
              </div>
            </CardContent>
          </Card>
        )}
